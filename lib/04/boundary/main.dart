      ...
      if (matchStart) {
        span.add(TextSpan(
          ...
          style: lightTextStyle.copyWith(
              backgroundColor: colors[0].withOpacity(0.5)),
        ));
      }
    }
        ...
        if (i != parts.length - 1) {
          ...
          if (matchStr != null) {
            if (matchStr.isNotEmpty) {
              ...
              Color color = colors[(i + 1) % colors.length].withOpacity(0.5);
              span.add(TextSpan(
                text: ' ',
                style: lightTextStyle.copyWith(backgroundColor: color),
              ));
            }
          }
        }
    ...
    if(allMatches.isNotEmpty){
      ...
      if (matchEnd) {
        span.add(TextSpan(
          ...
          style: lightTextStyle.copyWith(
              backgroundColor:
              colors[allMatches.length % colors.length].withOpacity(0.5)),
        ));
      }
    }
